...
def get_args_parser():
    ...
    parser.add_argument("--grad_steps", default=1, help="accumulation_steps ")
...
class DatasetMultiPositive(data.Dataset):
    ...
    def __getitem__(self, item):
        return [augs[item] for augs in self.augments_all]
...
#"D:\text_clustering_paper\EDA\StackOverflow_t5_2_augs\StackOverflow_t5_2__nlp0.2_4.txt"
        ...
        # while i == pre:
        #     i = np.random.randint(low=0, high=51)
        path = rf"D:/text_clustering_paper/EDA/StackOverflow_t5_{t5}_augs"
